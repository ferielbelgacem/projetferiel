...
<body>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputPassword4" value="<?PHP echo $reference ?>" name="reference" placeholder="reference">
    </div>
  </div>
  <div class="form-group">
    <div class="form-group col-md-6">
    <label for="inputAddress">Categorie</label>
    <input type="text" class="form-control" id="inputAddress" value="<?PHP echo $categorie ?>"  name="categorie"placeholder="+216 22 333 444">
  </div>
  <div class="form-group col-md-6">
    <label for="inputAddress">prix</label>
    <input type="text" class="form-control" id="inputAddress" value="<?PHP echo $prix ?>" name="prix" placeholder="prix">
  </div>
  </div>
  <div class="form-group">
        <div class="form-group col-md-12">
    <label for="inputAddress2">Etat</label>
    <input type="text" class="form-control" id="inputAddress2"value="<?PHP echo $etat?>"  name="etat" placeholder="etat">
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control"  value="<?PHP echo $quantite ?>"  name="quantite" id="quantite">
    </div>
  </div>
  <div class="form-group">
  </div>
...
if (isset($_POST['modifier'])){
  $Stock=new Stock($_POST['nom'],$_POST['reference'],$_POST['categorie'],$_POST['prix'],$_POST['etat'],$_POST['quantite']);
  $StockC->modifierStock($Stock,$_POST['id']);
  echo $_POST['id'];
