...
<script language="javascript" src=../js/controle.js>
</script>
  <!-- =======================================================
...
<body>
  ...
  <h1>Catalogue</h1>
    ...
    <form id="form-work" class="" action="../views/ajoutEmploye.php" method="GET" name="f" onsubmit="return verif()">
...
foreach($listeEmployes as $row){
 ...
 <td><a href="modifierEmploye.php?id=<?PHP echo $row['id_article']; ?>" style="text-decorations:none; color:white;"  class="btn btn-warning">
  Modifier</a></td>
  </tr>
  <?PHP
}
